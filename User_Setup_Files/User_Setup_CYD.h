...
// example #define USER_SETUP_INFO "User_Setup"
...
#define ILI9341_2_DRIVER // Alternative ILI9341 driver (Works with CYD). See
...
// parameters below for this display (For TTGO T-Display) #define R61581_DRIVER
